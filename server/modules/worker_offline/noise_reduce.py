...
#Noise Reduce
def noise_reduce(input_file,output_file,function,trimming):
        ...
        if function == 'power' :
            ...
            y = y_reduced_power
        elif function == 'centroid_s' :
            y_reduced_power = reduce_noise_centroid_s(y, sr)
            y = y_reduced_power
        elif function == 'centroid_mb' :
            y_reduced_power = reduce_noise_centroid_mb(y, sr)
            y = y_reduced_power
        elif function == 'mfcc_up' :
            y_reduced_power = reduce_noise_mfcc_up(y, sr)
            y = y_reduced_power
        elif function == 'mfcc_down' :
            y_reduced_power = reduce_noise_mfcc_down(y, sr)
            y = y_reduced_power
        elif function == 'median' :
            y_reduced_power = reduce_noise_median(y, sr)
            y = y_reduced_power

        if trimming == 'True' :
            # trimming silences
            y_trimming, time_trimmed = trim_silence(y)
            y = y_trimming
